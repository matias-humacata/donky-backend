 ...
 * POST /api/taller
 */
async function createOrUpdateConfig(req, res) {
  try {
 ...
 * DELETE /api/taller/diasNoLaborables/:fecha
 */
async function deleteDiaNoLaborable(req, res) {
  try {
 ...
 * DELETE /api/taller/vacaciones/:inicio/:fin
 */
async function deleteVacaciones(req, res) {
  try {
